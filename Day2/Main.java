...
public class Main {
    public static void main(String[] args) {
       ...
       for(Product p : products){
        ...
        Product p = service.getProductName("Logi Mouse");
        System.out.println(p);
        ...
        Product p2 = service.getProductPlace("White Table");
        System.out.println(p2);

        System.out.println("****************************************************");

        //Assignment part 2...................
        System.out.println("Search by product which are out of waranaty ");

        List<Product> pro = service.getProductOutOfWarrant("black");
        System.out.println(p2);
